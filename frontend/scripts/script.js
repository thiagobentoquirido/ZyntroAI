...
async function processStream(file, prompt) {
  ...
  const res = await fetch("https://zyntroai.onrender.com/process-stream", {
    method: "POST",
    body: formData,
  });
...
async function send() {
  ...
  try {
    ...
    ========================= */
    if (!selectedImage) {
      const res = await fetch("https://zyntroai.onrender.com/chat", {
        method: "POST",
    ...
    ========================= */
      ...
      const res = await fetch("https://zyntroai.onrender.com/process", {
        method: "POST",
        body: formData,
      });
